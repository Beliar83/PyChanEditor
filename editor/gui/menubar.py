...
class Menu(widgets.VBox):
    ...
    def removeAction(self, action):
        ...
        if isinstance(action, ActionGroup):
            ...
            editor.gui.action.changed.disconnect(self._updateActionGroup, sender=action)
    ...
    def _insertButton(self, action, position):
        ...
        if isinstance(action, ActionGroup):
            actions = action.getActions()
            editor.gui.action.changed.connect(self._updateActionGroup, sender=action)
...
class MenuButton(widgets.HBox):
    ...
    def initEvents(self):
        ...
        editor.gui.action.changed.connect(self._actionChanged, sender=self._action)
    ...
    def removeEvents(self):
        ...
        editor.gui.action.changed.disconnect(self.update, sender=self._action)
